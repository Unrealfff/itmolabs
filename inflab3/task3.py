...
"""
def is_ad(s):
    ptr = r"\w+ой|\w+ий|\w+ого|\w+его|\w+ому|\w+ему|\w+ым|\w+им|\w+ом|\w+ем|\w+ая|\w+ья|\w+ую|\w+ью|\w+ей|\w+ое|\w+ее|\w+ье|\w+ые|\w+ие|\w+ых|\w+их|\w+им|\w+ым|\w+ыми|\w+ими|\w+ый|\w+ий"
...
футбольного турнире пришла к журналисту Габриэлю Ано в 1955 году.""".lower()
